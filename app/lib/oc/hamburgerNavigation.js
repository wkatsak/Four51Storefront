...
function hamburgernavigation() {
    ...
    function template() {
        return [
            '<style>',
            //color changes start
            '.navbar-hamburger .main-toggle i {color:#ffffff;}',
            ...
            '.navbar.navbar-hamburger, .navbar.navbar-categories, .navbar.navbar-account, .navbar.navbar-all {min-height:40px; max-height:40px; padding-bottom:10px;margin-top:8px;}',
