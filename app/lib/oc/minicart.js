...
function minicart() {
    ...
    function template(){
        return [
            ...
            '    <div class="minicart">',
            '        <i class="fa fa-shopping-cart"></i> <span style="color: #ffffff !important; class="label label-default">{{cartCount + \' ITEM(S)\'}}</span> <span style="color: #ffffff !important; class="hidden-xs"> - {{currentOrder.Total | currency }}</span> <i style="color: #ffffff !important;" class="fa fa-caret-down"></i>',
            ...
            '                                <figure>',
            '                                    <img ng-src="{{lineitem.Variant.LargeImageUrl || lineitem.Product.SmallImageUrl}}" />',
            '                                </figure>',
            '                            </a>',
            '                        </div>',
            '                        <div class="col-xs-9">',
            ...
            '                </div>',
            '                <div class="col-xs-6">',
            '                    <a class="btn btn-create btn-block" ng-click="cartCheckOut()">Checkout</a>',
            '                </div>',
            '            </div>',
            '        </div>',
            '    </div>',
