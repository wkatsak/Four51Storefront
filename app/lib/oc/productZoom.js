...
function productzoom() {
    return {
        ...
        template:
            '<style>' +
            '.jetzoom-lens{ border:none;width:50%;height:25%;border-radius:20px;box-shadow:0 0 10px rgba(0,0,0,.4);cursor:none }' +
            ...
            '</style>'+
            '<div>'+
            '<img class="jetzoom img-responsive" style="max-height: 550px;">'+
            '</div>',
        link: function($scope) {
