...
function addtocartpreview() {
    ...
    function template() {
        return [
            ...
            '.fa-shopping-cart::before { color: #ffffff; }',
            ...
            '<h3 class="panel-title variant-gray">Variant List</h3>',
            '<loadingindicator ng-show="addToOrderIndicator" />',
            '</div>',
            ...
            '<p style="margin: 0; padding: 10px 0 0 0; float: left; font-weight: bold;">Item Specs</p>',
            '</div>',
            ...
            '<i ng-show="addToOrderForm.$invalid" class="fa fa-warning"></i>',
            '<span>Add List to Cart <i class="fa fa-shopping-cart"></i></span>',
            '</button>',
            '</div>',
            '</div>',
            '</div>'
